    ...
    return (
        ...
        <div className="row footer">
            ...
            <div className="row search-row">
                    <div className="col-lg-5  paddingless" ><div className="footer-logo-holder">
                        Logo here!
                      </div></div>
                    <div className="col-lg-7 ">   <div className="footer-search-holder paddingless">
        ...
        //             <div className="footer-first-col col-lg-3">
        ...
        //                 </div>
        //             </div>
        //             <div className="footer-secound-col col-lg-3">
